...
parser.add_argument('--correct-coef', default=0.05, type=float, help='correct coef for grad correction')
...
if args.net=="vit_small":
    ...
    from models.relora_grad_correction import ReLoRaModel
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        loss.backward()
        # TODO: param.grad.data = ???
        net.correct_grad()
        # param.grad.data = alpha * full_grad @ lora_b + (1-alpha) * param.grad.data
